              ...
              <swiper-slide v-for="slide in dataBanner" :key="slide.imageSrc">
                <div class="professional_banner-item">
                  ...
                  <div class="professional_banner-context">
                    ...
                    <p class="professional_banner-title">{{ slide.title }}</p>
          ...
          <div class="professional_pr2">
            <div class="professional_pr2-container container">
              ...
              <div class="professional_pr2-wrapper">
                <div
                  class="professional_pr2-item"
                  v-for="item in dataDiscover"
                  :key="item.title"
                >
            ...
            >
              <swiper-slide v-for="slide in dataMachine" :key="slide.imageSrc">
                <router-link :to="slide.link">
                  ...
                  <p class="professional_slide-name">{{ slide.name }}</p>
                </router-link>
              </swiper-slide>
            </swiper>
          </div>
          ...
          <div class="professional_pr">
            <div class="professional_pr-container container">
              ...
              <div class="professional_pr-wrapper container">
                ...
                >
                  <swiper-slide
                    v-for="(slide, index) in dataSolution"
                    :key="index"
                  >
          ...
          <section class="professional_container2">
            <div class="">
              ...
              <div class="professional_container2-list">
                <div
                  v-for="item in dataProfessional"
                  :key="item.item_title.span"
                  class="professional_container2-item"
                >
                  <div class="item_img">
                    <img :src="item.item_img.src" />
                  </div>
                  <div class="item_title">
                    <span>{{ item.item_title.span }}</span>
                  </div>
                </div>
              </div>
