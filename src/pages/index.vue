    ...
    return {
      ...
      dataInfo2: [
        ...
        },
        {
          ...
          image: "assets/images/Rectangle_1.png",
        },
      ],
      dataInfo: [
        {
          ...
          image: "assets/images/Rectangle_5.png",
        },
        {
          ...
          image: "assets/images/Rectangle_3.png",
        },
        {
          ...
          image: "assets/images/Rectangle_4.png",
        },
      ],
      dataFeatured: [
        {
          ...
          image: "assets/images/Calque_1.png",
        },
        {
    ...
    <main id="index">
        ...
        <div class="featured_wrapper" id="featured">
          ...
          >
            <div class="featured_item-content">
              ...
              <p class="featured_item-content-des">{{ item.des }}</p>
            ...
            <div class="featured_item-inner">
              ...
              <div class="featured_item-main">
                <h3 class="featured_item-header">{{ item.heading }}</h3>
                <p class="featured_item-des">{{ item.tiltle }}</p>
              </div>
      ...
      <section id="moreInfo" class="moreInfo">
        <div class="container moreInfo_list">
          <MoreItem v-bind:data="dataInfo2" />
        </div>
      </section>
